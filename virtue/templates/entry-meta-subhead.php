<div class="subhead">
    ...
    <i class="icon-user"></i> <?php esc_html_e('by', 'virtue');?>  <span itemprop="author"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta('ID') ) ); ?>" class="fn" rel="author"><?php echo esc_html( get_the_author() ); ?></a></span> |</span>
