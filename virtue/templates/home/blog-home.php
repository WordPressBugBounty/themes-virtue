				                    ...
				                    <header class="home_blog_title">
			                          	<a href="<?php the_permalink() ?>">
			                          		...
			                          		<div class="subhead color_gray">
			                          			<span class="postauthortop author vcard" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo esc_attr( get_the_author() ) ?>">
			                          				<span itemprop="author" class="kt_hidden"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta('ID') ) ); ?>" class="fn" rel="author"><?php echo esc_html( get_the_author() ); ?></a></span>
			                          				<i class="icon-user"></i>
			                          			</span>
